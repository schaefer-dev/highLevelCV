...
\begin{document}
    ...
    \begin{frame}{Motivation}
        ...
        % So overall in 2013 there were over 3000 people killed and over 400.000 injured in motor vehicle crashes involving distracted drivers.\\
        \begin{itemize}
		...
		\vspace{0.5cm}
		% -> distraction-detection is a really important topic to reduce these numbers!
		$\Rightarrow$ Simple cameras combined with CV algorithms are non-intrusive and relatively cheap! % solution to achieve this goal.
	...
	\begin{frame}
		...
		1 Training Participant, 1 test, all classes
		\begin{columns}
			\begin{column}{0.5\textwidth}
				\begin{center}
					\includegraphics[width=\textwidth]{mult_HOG/1c0123456789mat}\\					
				\end{center}
			\end{column}
			\begin{column}{0.5\textwidth}
				\begin{center}
					\includegraphics[width=\textwidth]{mult_HOG/1c0123456789rep}
				\end{center}
			\end{column}
		\end{columns}		
	\end{frame}
