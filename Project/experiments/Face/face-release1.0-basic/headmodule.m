...
ims = dir('C:\Users\enggr\Documents\git\openface-master\dlib-19.0\examples\faces\driving\newTest/*.jpg');
for i = 1:length(ims),
    fprintf('testing: %d/%d\n', i, length(ims));
    im = imread(['C:\Users\enggr\Documents\git\openface-master\dlib-19.0\examples\faces\driving\newTest\' ims(i).name]);
